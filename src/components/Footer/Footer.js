...
const Footer = ({ padding }) => {
  const paddingBottom = padding ? '10rem' : '4rem';
    ...
    <div css={styles}>
      <div className='footer' style={{ paddingBottom: paddingBottom }}>
        ...
        <div className='social'>
          ...
          <a href="https://www.facebook.com/CoCherryCO" target='_blank' rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <span>Web Design & Development by <a className='inline-button'href="https://www.alexhopkins.dev/" target='_blank' rel="noopener noreferrer" >Alex Hopkins</a></span>
      </div>
    </div>
  );
};
